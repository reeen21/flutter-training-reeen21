...
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is WeatherState&&(identical(other.weatherForecast, weatherForecast) || other.weatherForecast == weatherForecast)&&(identical(other.error, error) || other.error == error));
}


@override
int get hashCode => Object.hash(runtimeType,weatherForecast,error);

@override
String toString() {
  return 'WeatherState(weatherForecast: $weatherForecast, error: $error)';
}
...
/// Create a copy of WeatherState
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? weatherForecast = freezed,Object? error = freezed,}) {
...
class _WeatherState implements WeatherState {
  const _WeatherState({this.weatherForecast = null, this.error = null});
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _WeatherState&&(identical(other.weatherForecast, weatherForecast) || other.weatherForecast == weatherForecast)&&(identical(other.error, error) || other.error == error));
}
...
/// Create a copy of WeatherState
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? weatherForecast = freezed,Object? error = freezed,}) {
